...
export function drawClimbableSurface(
  ...
  const markerHeight = Math.max(96, worldHeight - CLIMBABLE_SURFACE_MARKER_TOP * 2);
  ...
  context.fillText(CLIMBABLE_SURFACE_LABEL, surface.position.x, CLIMBABLE_SURFACE_MARKER_TOP + 24);
}
