...
/**
 * Repository link for the fixed top-right cluster. A plain server-rendered
 * anchor on purpose: it is the site's one outbound link to the project, so it
 * has to be in the HTML as served rather than appear after hydration.
 */
