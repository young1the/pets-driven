...
const EXPRESSIVE_POSE_CHOREOGRAPHY: Partial<Record<string, PoseChoreography>> = {
  ...
  // ── Working beats ─────────────────────────────────────────────────────────
  // Work behaviors hold one honest native row. Personality comes from ordinary
  // decision scores and duration rather than stitched animation rows.
  "work-focus": [{ state: "running", durationMs: 1_000 }],
  "work-review": [{ state: "review", durationMs: 1_000 }],
  // ── Acknowledge beats ─────────────────────────────────────────────────────
